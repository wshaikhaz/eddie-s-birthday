...
const WaxSeal = () => (
  <div className="absolute z-20 left-1/2 -translate-x-1/2 bottom-[38%]">
    <div
      ...
      style={{
        background:
          "radial-gradient(circle at 35% 35%, hsl(0 72% 45%), hsl(0 72% 35%) 50%, hsl(0 72% 25%))",
        boxShadow:
          "0 4px 12px rgba(120, 20, 20, 0.4), inset 0 -2px 4px rgba(0,0,0,0.2), inset 0 2px 4px rgba(255,255,255,0.1)"
      }}
    >
      <span
        className="font-display text-cream text-xl font-bold select-none"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, hsl(30 40% 92%), hsl(30 35% 86%))",
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, hsl(30 30% 88%) 0%, hsl(30 35% 92%) 100%)"
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, hsl(30 35% 90%), hsl(30 30% 85%))",
      ...
      <div className="absolute bottom-[15%] left-1/2 -translate-x-1/2 text-center z-10">
        <p className="font-cursive text-foreground/60 text-sm">
          To Eddle Mae Gutang
        </p>
      </div>
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, hsl(30 30% 87%), hsl(30 35% 90%))",
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, hsl(30 35% 84%), hsl(30 30% 80%))",
            clipPath: "polygon(0 0, 100% 0, 50% 100%)",
            backfaceVisibility: "hidden",
